package com.inforefiner.rtcflow.steps.sink.jdbc;

import com.inforefiner.rtcflow.util.AesCryptor;
import com.inforefiner.rtcflow.util.CheckUtil;
import com.inforefiner.rtcflow.util.ConvertUtil;
import com.inforefiner.rtcflow.util.StepFieldUtil;
...
@StepBind(id = "custom_sink_jdbc_upsert", outputCount = 0, outputIds = {},
...
class JDBCSinkSettings extends StepSettings {
    ...
    @Setting(defaultValue = "HDFS", values = {"HDFS", "KAFKA", "ELASTICSEARCH", "HBASE", "JDBC", "FTP", "REDIS"},
            description = "Sink输出类型", compositeStep = true)
    private String type;
